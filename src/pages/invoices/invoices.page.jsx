...
export default function InvoicesPage() {
  ...
  const { data: invoices, isLoading, isError, error } = useGetInvoicesforUserQuery();
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#f0f4f8] via-[#d9e8f5] to-[#e8f0f7] p-6">
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-2xl w-full">
          ...
          <pre className="bg-gray-50 p-4 rounded-lg text-sm text-gray-700 overflow-auto border border-gray-200">
  ...
  const totalPages = Math.max(1, Math.ceil((filteredInvoices?.length || 0) / pageSize));
              ...
              {!filteredInvoices || filteredInvoices.length === 0 ? (
                ...
                <>
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-700 px-4 py-3">
                    <span>
                      Showing {(start + 1).toLocaleString()}-{Math.min(end, filteredInvoices.length).toLocaleString()} of{" "}
